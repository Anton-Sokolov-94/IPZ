...
from BrainStorm.models import StudentsCourses, Courses, UserProfile
...
def edit_profile(request, form_class=None, success_url=None,
    ...
    **Template:**
    ...
    courses = []
    u_id = UserProfile.objects.get(pk=request.user.id).user_type
    if u_id:
        courses_id = StudentsCourses.objects.filter(student_id = request.user.id)####################################################
        for each in courses_id:
            courses.append(Courses.objects.get(pk=each.course_id))
    else:
        courses = Courses.objects.filter(lector_id=request.user.id)
...
def profile_list(request, public_profile_field=None,
    ...
    **Template:**
    ...
    return ListView(request, template_name=template_name, **kwargs)
